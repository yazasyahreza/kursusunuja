            ...
            <div class="col-12">
                <div class="card flex-fill">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Edit Data Peserta</h5>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('master.peserta.update', $peserta->id_peserta) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="username" id="username"
                                            ...
                                            value="{{ old('username', $peserta->user->username) }}" required>
                                        @error('username')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
